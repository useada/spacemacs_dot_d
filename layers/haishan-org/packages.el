...
(defun haishan-org/post-init-org-pomodoro ()
  (progn
    (add-hook 'org-pomodoro-finished-hook '(lambda () (haishan/growl-notification "Pomodoro Finished" "☕️ Have a break!" t)))
    (add-hook 'org-pomodoro-short-break-finished-hook '(lambda () (haishan/growl-notification "Short Break" "🐝 Ready to Go?" t)))
    (add-hook 'org-pomodoro-long-break-finished-hook '(lambda () (haishan/growl-notification "Long Break" " 💪 Ready to Go?" t)))
    ))

;;In order to export pdf to support Chinese, I should install Latex at here: https://www.tug.org/mactex/
;; http://freizl.github.io/posts/2012-04-06-export-orgmode-file-in-Chinese.html
;;http://stackoverflow.com/questions/21005885/export-org-mode-code-block-and-result-with-different-styles
(defun haishan-org/post-init-org ()
...
unwanted space when exporting org-mode to html."
      ...
      (setq org-capture-templates
            '(("t" "Todo" entry (file+headline "~/org-notes/gtd.org" "Workspace")
              ...
              ("c" "Chrome" entry (file+headline "~/org-notes/notes.org" "Quick notes")
               "* TODO [#C] %?\n %(haishan/retrieve-chrome-current-tab-url)\n %i\n %U"
               :empty-lines 1)
      ...
      (setq org-agenda-custom-commands
            '(
              ...
              ("pl" tags-todo "PROJECT+DREAM+CATEGORY=\"haishan\"")
              ("W" "Weekly Review"
               ((stuck "") ;; review stuck projects as designated by org-stuck-projects
                (tags-todo "PROJECT") ;; review all projects (assuming you use todo keywords to designate projects)
                ))))

      (defvar haishan-website-html-preamble
        "<div class='nav'>
<ul>
<li><a href='http://haishan.com'>博客</a></li>
<li><a href='/index.html'>Wiki目录</a></li>
</ul>
</div>")
      (defvar haishan-website-html-blog-head
      ...
      (setq org-publish-project-alist
            `(
              ("blog-notes"
               ...
               :recursive t
               :html-head , haishan-website-html-blog-head
               ...
               :section-numbers nil
               :html-preamble ,haishan-website-html-preamble
               :author "haishan"
...
(defun haishan-org/init-org-mac-link ()
...
(defun haishan-org/post-init-ox-reveal ()
  (setq org-reveal-root "file:///Users/guanghui/.emacs.d/reveal-js"))

(defun haishan-org/init-org-octopress ()
...
(defun haishan-org/init-org-tree-slide ()
  (use-package org-tree-slide
    :init
    (spacemacs/set-leader-keys "oto" 'org-tree-slide-mode)))


(defun haishan-org/init-org-download ()
  (use-package org-download
    :defer t
    :init
    (org-download-enable)))

(defun haishan-org/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/org-notes")))

(defun haishan-org/init-worf ()
  (use-package worf
    :defer t
    :init
    (add-hook 'org-mode-hook 'worf-mode)))

(defun haishan-org/post-init-deft ()
  (progn
