...
(defun haishan-misc/init-helm-ag ()
  (use-package helm-ag
    :defer t
    :init
    (progn
...
(defun haishan-misc/post-init-gist ()
  (use-package gist
    :defer t
    :init
...
(defun haishan-misc/init-peep-dired ()
...
(defun haishan-misc/post-init-flyspell-correct ()
  (progn
    (with-eval-after-load 'flyspell
      (define-key flyspell-mode-map (kbd "C-;") 'flyspell-correct-previous-word-generic))
    (setq flyspell-correct-interface 'flyspell-correct-ivy)))

(defun haishan-misc/post-init-smartparens ()
...
(defun haishan-misc/init-tiny ()
  (use-package tiny
    :defer t
    :init
    (spacemacs/set-leader-keys "oe" 'tiny-expand)))

(defun haishan-misc/post-init-helm ()
...
(defun haishan-misc/init-helm-github-stars ()
  (use-package helm-github-stars
    :commands (helm-github-stars)
    :init
    (setq helm-github-stars-username "haishan")))




(defun haishan-misc/post-init-fcitx ()
  (fcitx-aggressive-setup))

(defun haishan-misc/post-init-command-log ()
...
(defun haishan-misc/init-litable ()
  (use-package litable
    :init
    :defer t))

(defun haishan-misc/init-osx-dictionary ()
...
(defun haishan-misc/init-4clojure ()
...
(defun haishan-misc/post-init-avy ()
  (progn
    (global-set-key (kbd "C-s-'") 'avy-goto-char-2)
    (global-set-key (kbd "M-'") 'avy-goto-char-2)))

(defun haishan-misc/post-init-ace-window ()
  (global-set-key (kbd "C-x C-o") #'ace-window))

(defun haishan-misc/init-discover-my-major ()
...
(defun haishan-misc/post-init-elfeed ()
  (use-package elfeed
    :init
...
(defun haishan-misc/post-init-evil ()
  (progn
    ...
    (define-key evil-normal-state-map
      (kbd "Y") 'haishan/yank-to-end-of-line)
    ...
    (define-key evil-visual-state-map (kbd "C-r") 'haishan/evil-quick-replace)
    ...
    ;; (defadvice evil-insert-state (around haishan/holy-mode activate)
...
(defun haishan-misc/init-visual-regexp ()
  (use-package visual-regexp
    :commands (vr/replace vr/query-replace)))

(defun haishan-misc/init-visual-regexp-steroids ()
...
(defun haishan-misc/init-multiple-cursors ()
...
;;; Occasionally useful
    ...
    (setq mc/cmds-to-run-once
          '(
            counsel-M-x
            haishan/my-mc-mark-next-like-this))
...
(defun haishan-misc/post-init-persp-mode ()
...
(defun haishan-misc/post-init-chinese-wbim ()
  (progn
...
(defun haishan-misc/post-init-evil-escape ()
  (setq evil-escape-delay 0.2))

(defun haishan-misc/init-find-file-in-project ()
...
(defun haishan-misc/post-init-projectile ()
  (progn
  ...
  current project. Otherwise do `occur' in the current file."
    ...
    (spacemacs/set-leader-keys "pf" 'haishan/open-file-with-projectile-or-counsel-git)
    (spacemacs/set-leader-keys "pt" 'my-simple-todo)))



(defun haishan-misc/post-init-prodigy ()
  (progn
    (prodigy-define-tag
      :name 'jekyll
...
(defun haishan-misc/init-moz-controller ()
...
(defun haishan-misc/init-ag ()
  (use-package ag
    :init))

(defun haishan-misc/post-init-erc ()
  (progn
    (add-hook 'erc-text-matched-hook 'my-erc-hook)
    (spaceline-toggle-erc-track-off)))

(defun haishan-misc/init-wrap-region ()
...
(defun haishan-misc/init-keyfreq ()
  (use-package keyfreq
    :init
    (progn
      (keyfreq-mode t)
...
(defun haishan-misc/post-init-swiper ()
...
(defun haishan-misc/post-init-magit ()
  (progn
    ...
    (eval-after-load 'magit
      '(define-key magit-mode-map (kbd "C-c g")
         #'haishan/magit-visit-pull-request))

    (setq magit-process-popup-time 10)))

(defun haishan-misc/post-init-git-messenger ()
...
(defun haishan-misc/post-init-markdown-mode ()
  (progn
