...
(defun haishan-ui/init-zilong-mode-line ()
  (defun haishan/display-mode-indent-width ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (propertize
                          ...
                          'font-lock-type-face))
                 " "
                 '(:eval (haishan/update-persp-name))
                 ...
                 '(:eval (haishan/display-mode-indent-width))
                 ;; line and column
...
(defun haishan-ui/post-init-diminish ()
  (progn
...
(defun haishan-ui/post-init-spaceline ()
...
(defun haishan-ui/init-evil-vimish-fold ()
...
(defun haishan-ui/post-init-hl-anything ()
  (progn
...
(defun haishan-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
(defun haishan-ui/post-init-popwin ()
  (progn
    (push "*haishan/run-current-file output*" popwin:special-display-config)
    (delete "*Async Shell Command*" popwin:special-display-config)))

(defun haishan-ui/post-init-whitespace ()
  (progn
