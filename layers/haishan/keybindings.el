;;; keybindings.el --- haishan Layer packages File for Spacemacs
;;
...
(global-set-key [(shift return)] 'haishan/smart-open-line)
(global-set-key (kbd "s-/") 'hippie-expand)
(global-set-key (kbd "C-c a") 'org-agenda)
(define-key global-map (kbd "C-c y") 'youdao-dictionary-search-at-point+)
(define-key global-map (kbd "<f9>") 'org-capture)
(define-key global-map (kbd "C-c t") 'org-capture)
(define-key global-map (kbd "<f8>") 'haishan/show-current-buffer-major-mode)
...
(global-set-key (kbd "s-d") 'haishan/my-mc-mark-next-like-this)
(bind-key* "s-r" 'mc/reverse-regions)
(global-set-key (kbd "<f5>") 'haishan/run-current-file)
...
(when (spacemacs/system-is-mac)
 (spacemacs/set-leader-keys "o!" 'haishan/iterm-shell-command))
...
;; (bind-key* "s-r" 'haishan/browser-refresh--chrome-applescript)
(bind-key* "s-;" 'haishan/insert-semicolon-at-the-end-of-this-line)
(bind-key* "C-s-;" 'haishan/delete-semicolon-at-the-end-of-this-line)
(bind-key* "s-," 'haishan/insert-comma-at-the-end-of-this-line)
;; (bind-key* "C-s-," 'haishan/delete-comma-at-the-end-of-this-line)
(bind-key* "C-c l" 'haishan/insert-chrome-current-tab-url)
;; (bind-key* "M-s o" 'occur-dwim)
(bind-key* "C-=" 'er/expand-region)
(bind-key* "M--" 'haishan/goto-match-paren)
...
(global-set-key (kbd "<f1>") 'haishan/helm-hotspots)
(spacemacs/set-leader-keys "oo" 'haishan/helm-hotspots)

(spacemacs/set-leader-keys "oc" 'my-auto-update-tags-when-save)
(spacemacs/set-leader-keys "op" 'haishan/org-save-and-export)
(spacemacs/set-leader-keys "fR" 'haishan/rename-file-and-buffer)
...
(spacemacs/set-leader-keys "oac" 'haishan/browser-refresh--chrome-applescript)
...
(spacemacs/set-leader-keys "sj" 'haishan/counsel-imenu)
;; deal with BOM
...
(spacemacs/set-leader-keys "oll" 'haishan/load-my-layout)
(spacemacs/set-leader-keys "ols" 'haishan/save-my-layout)
(spacemacs/set-leader-keys "ob" 'popwin:display-last-buffer)
(spacemacs/set-leader-keys "oy" 'youdao-dictionary-search-at-point+)

(bind-key* "s-p" 'find-file-in-project)
(spacemacs/set-leader-keys "os" 'haishan/search-in-fireball)
