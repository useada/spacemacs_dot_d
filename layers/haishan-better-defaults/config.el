...
(defun haishan/cleanup-recentf-and-known-projects ()
  (progn
...
(add-hook 'kill-emacs-hook #'haishan/cleanup-recentf-and-known-projects)
...
(defun haishan/stop-using-minibuffer ()
  "kill the minibuffer"
  (when (and (>= (recursion-depth) 1) (active-minibuffer-window))
    (abort-recursive-edit)))

(add-hook 'mouse-leave-buffer-hook 'haishan/stop-using-minibuffer)
