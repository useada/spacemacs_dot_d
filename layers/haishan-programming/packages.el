;;; packages.el --- haishan Layer packages File for Spacemacs
;;
...
(setq haishan-programming-packages
      '(
        css-mode
        paredit
        lispy
...
(defun haishan-programming/post-init-robe ()
  (progn
    (add-hook 'inf-ruby-mode-hook 'spacemacs/toggle-auto-completion-on)
    (defun haishan/ruby-send-current-line (&optional print)
    ...
    (defun haishan/ruby-send-current-line-and-go ()
      (interactive)
      (haishan/ruby-send-current-line)
      (ruby-switch-to-inf t))

    (defun haishan/start-inf-ruby-and-robe ()
      (interactive)
    ...
    (dolist (mode '(ruby-mode enh-ruby-mode))
      (spacemacs/set-leader-keys-for-major-mode mode
        "sb" 'ruby-send-block
        "sB" 'ruby-send-buffer
        "sl" 'haishan/ruby-send-current-line
        "sL" 'haishan/ruby-send-current-line-and-go
        "sI" 'haishan/start-inf-ruby-and-robe))))

(defun haishan-programming/init-editorconfig ()
  (use-package editorconfig
    :init
    (progn
      (defun conditional-enable-editorconfig ()
        (if (and (haishan/vcs-project-root)
                 (locate-dominating-file default-directory ".editorconfig"))
            (editorconfig-apply)))
      (add-hook 'prog-mode-hook 'conditional-enable-editorconfig))))

(defun haishan-programming/post-init-cider ()
  (setq cider-cljs-lein-repl
        "(do (require 'figwheel-sidecar.repl-api)
           (figwheel-sidecar.repl-api/start-figwheel!)
           (figwheel-sidecar.repl-api/cljs-repl))")

  (defun haishan/cider-figwheel-repl ()
    (interactive)
    (save-some-buffers)
  ...
  (global-set-key (kbd "C-c C-f") #'haishan/cider-figwheel-repl))

(defun haishan-programming/post-init-graphviz-dot-mode ()
  (with-eval-after-load 'graphviz-dot-mode
      (require 'company-keywords)
      (push '(graphviz-dot-mode  "digraph" "node" "shape" "subgraph" "label" "edge" "bgcolor" "style" "record") company-keywords-alist)))

(defun haishan-programming/post-init-dumb-jump ()
...
(defun haishan-programming/post-init-clojure-mode ()
  )

(defun haishan-programming/post-init-emacs-lisp ()
    (remove-hook 'emacs-lisp-mode-hook 'auto-compile-mode))

(defun haishan-programming/post-init-python ()
  (add-hook 'python-mode-hook #'(lambda () (modify-syntax-entry ?_ "w")))
  ;; if you use pyton3, then you could comment the following line
  (setq python-shell-interpreter "python"))

(defun haishan-programming/post-init-js-doc ()
  (setq js-doc-mail-address "guanghui8827@gmail.com"
        js-doc-author (format "Guanghui Qu <%s>" js-doc-mail-address)
        js-doc-url "http://www.haishan.com"
        js-doc-license "MIT")
...
(defun haishan-programming/init-ctags-update ()
...
;; (defun haishan-programming/init-js-comint ()
...
(defun haishan-programming/post-init-web-mode ()
...
(defun haishan-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'haishan/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun haishan-programming/post-init-racket-mode ()
  (progn
...
(defun haishan-programming/post-init-json-mode ()
...
(defun haishan-programming/init-nodejs-repl ()
  (use-package nodejs-repl
    :init
    :defer t))

(defun haishan-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun haishan-programming/init-lispy ()
  (use-package lispy
    :defer t
    :diminish (lispy-mode)
    :init
...
(defun haishan-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun haishan-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun haishan-programming/post-init-cmake-mode ()
  (progn
...
(defun haishan-programming/post-init-flycheck ()
...
(defun haishan-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun haishan-programming/init-impatient-mode ()
  "Initialize impatient mode"
  (use-package impatient-mode
    :init
    (progn
      (add-hook 'web-mode-hook 'haishan/impatient-mode-hook)
...
(defun haishan-programming/post-init-js2-refactor ()
  (progn
    (spacemacs/set-leader-keys-for-major-mode 'js2-mode
      "r>" 'js2r-forward-slurp
      "r<" 'js2r-forward-barf)))

(defun haishan-programming/post-init-js2-mode ()
  (progn
    ...
    (haishan|toggle-company-backends company-tern)
...
(defun haishan-programming/post-init-css-mode ()
  (progn
...
(defun haishan-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function haishan/init-<extension-name>
;;
(defun haishan-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun haishan-programming/init-nodejs-repl-eval ()
...
(defun haishan-programming/post-init-lua-mode ()
  (progn
...
(defun haishan-programming/post-init-cc-mode ()
  (progn
...
(defun haishan-programming/init-flycheck-clojure ()
  (use-package flycheck-clojure
    :defer t
    :init
    (eval-after-load 'flycheck '(flycheck-clojure-setup))))

(defun haishan-programming/post-init-ycmd ()
  (progn
    ...
    (haishan|toggle-company-backends company-ycmd)
...
(defun haishan-programming/init-etags-select ()
...
(defun haishan-programming/init-gulpjs ()
  (use-package gulpjs
    :init
    (progn
...
(defun haishan-programming/init-paredit ()
  (use-package paredit
...
(defun haishan-programming/post-init-company ()
  (progn
...
(defun haishan-programming/post-init-company-c-headers ()
  (progn
